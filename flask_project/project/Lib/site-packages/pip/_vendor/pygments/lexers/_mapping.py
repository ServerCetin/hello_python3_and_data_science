...
LEXERS = {
    ...
    'Angular2HtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML + Angular2', ('templates+ng2',), ('*.ng2',), ()),
    ...
    'CheetahHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Cheetah', ('templates+cheetah', 'templates+spitfire', 'htmlcheetah'), (), ('text/templates+cheetah', 'text/templates+spitfire')),
    ...
    'DtdLexer': ('pip._vendor.pygments.lexers.templates', 'DTD', ('dtd',), ('*.dtd',), ('application/xml-dtd',)),
    ...
    'EvoqueHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Evoque', ('templates+evoque',), ('*.templates',), ('text/templates+evoque',)),
    ...
    'HamlLexer': ('pip._vendor.pygments.lexers.templates', 'Haml', ('haml',), ('*.haml',), ('text/x-haml',)),
    'HandlebarsHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Handlebars', ('templates+handlebars',), ('*.handlebars', '*.hbs'), ('text/templates+handlebars', 'text/x-handlebars-template')),
    ...
    'HtmlDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Django/Jinja', ('templates+django', 'templates+jinja', 'htmldjango'), (), ('text/templates+django', 'text/templates+jinja')),
    'HtmlGenshiLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Genshi', ('templates+genshi', 'templates+kid'), (), ('text/templates+genshi',)),
    'HtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML', ('templates',), ('*.templates', '*.htm', '*.xhtml', '*.xslt'), ('text/templates', 'application/xhtml+xml')),
    'HtmlPhpLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+PHP', ('templates+php',), ('*.phtml',), ('application/x-php', 'application/x-httpd-php', 'application/x-httpd-php3', 'application/x-httpd-php4', 'application/x-httpd-php5')),
    'HtmlSmartyLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Smarty', ('templates+smarty',), (), ('text/templates+smarty',)),
    ...
    'LassoHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Lasso', ('templates+lasso',), (), ('text/templates+lasso', 'application/x-httpd-lasso', 'application/x-httpd-lasso[89]')),
    ...
    'MakoHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Mako', ('templates+mako',), (), ('text/templates+mako',)),
    ...
    'MyghtyHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Myghty', ('templates+myghty',), (), ('text/templates+myghty',)),
    ...
    'PugLexer': ('pip._vendor.pygments.lexers.templates', 'Pug', ('pug', 'jade'), ('*.pug', '*.jade'), ('text/x-pug', 'text/x-jade')),
    ...
    'RhtmlLexer': ('pip._vendor.pygments.lexers.templates', 'RHTML', ('rhtml', 'templates+erb', 'templates+ruby'), ('*.rhtml',), ('text/templates+ruby',)),
    ...
    'ScamlLexer': ('pip._vendor.pygments.lexers.templates', 'Scaml', ('scaml',), ('*.scaml',), ('text/x-scaml',)),
    ...
    'TwigHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Twig', ('templates+twig',), ('*.twig',), ('text/templates+twig',)),
    ...
    'VelocityHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Velocity', ('templates+velocity',), (), ('text/templates+velocity',)),
    ...
    'XmlLexer': ('pip._vendor.pygments.lexers.templates', 'XML', ('xml',), ('*.xml', '*.xsl', '*.rss', '*.xslt', '*.xsd', '*.wsdl', '*.wsf'), ('text/xml', 'application/xml', 'image/svg+xml', 'application/rss+xml', 'application/atom+xml')),
    ...
    'XsltLexer': ('pip._vendor.pygments.lexers.templates', 'XSLT', ('xslt',), ('*.xsl', '*.xslt', '*.xpl'), ('application/xsl+xml', 'application/xslt+xml')),
